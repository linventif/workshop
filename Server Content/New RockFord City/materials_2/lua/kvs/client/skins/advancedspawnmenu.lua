...
SKIN.PrintName		= "KVS based Derma Skin"
SKIN.Author		= "Venatuss"
SKIN.DermaVersion	= 1
SKIN.GwenTexture	= Material( "kvs-lib/skin.png" )
...
SKIN.fontFrame					= font( "Rajdhani", 18 )
...
SKIN.fontCategoryHeader			= font( "Rajdhani", 18 )
...
SKIN.Colours.Button = {}
SKIN.Colours.Button.Normal			= Color( 235, 235, 235, 255 )
SKIN.Colours.Button.Hover			= Color( 255, 255, 255, 255 )
SKIN.Colours.Button.Down			= Color( 235, 235, 235, 255 )
...
derma.DefineSkin( "KVS.Skin", "KVS Library colors", SKIN )