local att = {}
att.name = "md_g17laser"
att.displayName = "Internal Laser"
att.displayNameShort = "I. Laser"
att.laserRange = 4096
...
if CLIENT then
	att.displayIcon = surface.GetTextureID("atts/NeN/bg_g17laser")
	...
	function att:elementRender()
		local model = self.AttachmentModelsVM.md_g17laser.ent
