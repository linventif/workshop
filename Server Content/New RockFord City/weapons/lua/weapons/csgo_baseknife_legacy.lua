-- This is the older version of baseknife which uses SetMaterial to switch skins.
-- I left it to not break compatibility with existing forks.
-- If you want use this instead of newer baseknife, change SWEP.Base = "csgo_baseknife"
-- of each needed knife into SWEP.Base = "csgo_baseknife_legacy".
-- Please note that I won't support this baseknife anymore.
