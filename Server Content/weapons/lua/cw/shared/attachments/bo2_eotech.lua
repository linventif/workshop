...
if CLIENT then
	att.displayIcon = surface.GetTextureID("atts/bo2_eotech")
	att.description = {[1] = {t = "Provides a bright reticle to ease aiming.", c = CustomizableWeaponry.textColors.POSITIVE}}


	
	att.reticle = "bo2r/attachments/reticles/eotech_reticule"
	att._reticleSize = 7.3
