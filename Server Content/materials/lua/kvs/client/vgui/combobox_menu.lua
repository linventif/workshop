...
function PANEL:AddOption( strText, funcFunction )
	...
	pnl:SetMenu( self )
	pnl:SetText( strText )
	pnl:SetFont( font( 'Vegur', 19 ) )
	pnl:SetColor( config( 'vgui.color.white' ) )
...
function PANEL:Paint( w, h )
	...
	draw.RoundedBoxEx( 5, 0, 0, w, h, config( 'vgui.color.light_black' ), false, false, true, true )
	return true
end
...
derma.DefineControl( 'KVS.ComboBoxMenu', nil, PANEL, 'DMenu' )