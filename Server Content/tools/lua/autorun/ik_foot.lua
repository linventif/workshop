		...
		if IsValid( ply ) then
			...
			if lFoot and rFoot and lCalf and rCalf and lThigh and rThigh then
				...
				elseif not ply.IKResetManipulationBones then
					ply:ManipulateBonePosition( 0, Vector() )
					ply:ManipulateBoneAngles( 0, Angle() )
								
					ply:ManipulateBoneAngles(lCalf, Angle() )
					ply:ManipulateBoneAngles(rCalf, Angle() )
					
					ply:ManipulateBoneAngles(lThigh, Angle() )
					ply:ManipulateBoneAngles(rThigh, Angle() )
					
					ply:ManipulateBoneAngles(lFoot, Angle() )
					ply:ManipulateBoneAngles(rFoot, Angle() )
